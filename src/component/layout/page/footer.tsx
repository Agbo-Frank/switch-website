...
export default function Footer() {
  return (
    <>
      <Container contentClassName="px-0 bg-surface-elevated">
        <div className="center py-10 sm:py-[70px] px-4">
          <div className="w-full max-w-[733px] flex flex-col gap-8 sm:gap-[35.02px] text-center mx-auto">
            ...
            <div className="flex flex-col sm:flex-row center gap-3 sm:gap-[17.51px] sm:h-[72px]">
              <PrimaryButton className="w-full sm:w-auto h-14 sm:h-full px-6 sm:px-10">
                <span className="text-[18px] sm:text-[26.76px]! font-regular leading-[100%] font-tomato">Book a demo</span>
              </PrimaryButton>
              <SecondaryButton className="w-full sm:w-auto h-14 sm:h-full px-6 sm:px-10">
      ...
      <Container>
        <div className="w-full max-w-[1100px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6 py-8 md:py-[44px]">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-[26.27px] text-center sm:text-left">
            ...
            <span className="text-white/30 text-base sm:text-xl md:text-[35.02px] font-tomato leading-[100%]">
      ...
      <Container>
        <div className="w-full max-w-[1100px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 py-6 sm:py-[38px]">
